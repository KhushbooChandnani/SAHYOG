...
import 'package:flutter_uikit/ui/page/contacts/add_contacts.dart';
...
class MyApp extends StatelessWidget {
  final materialApp = MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        UIData.homeRoute: (BuildContext context) => LoginTwoPage(),
        ...
        UIData.settingsOneRoute: (BuildContext context) => AddContact(),
        ...
        UIData.shoppingThreeRoute: (BuildContext context) =>
            ProductDetailPage(),
        UIData.loginOneRoute: (BuildContext context) => AddContact(),
